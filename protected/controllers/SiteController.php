	...
	public function actionContact()
	{
		...
		if(isset($_POST['ContactForm']))
		{
			...
			if($model->validate())
			{
				...
				mail('Jangkoo Contact <contact@linxhq.com>',$subject,$model->body,$headers);
			...
			$message->setTo(array('contact@linxhq.com' => 'Jangkoo Contact'));
			$message->setFrom(array($emailAddr => $name . " (Jangkoo)"));
			$message->setReplyTo(array($emailAddr => $name . " (Jangkoo)"));
